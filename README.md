# EECS 281 & Coding Interviews Review Sheet

Very basic, brief summary of data structures and algorithms. Meant to be useful for both midterm and final exam multiple choice section.

## Contributing
This is an open source, community project, and I am grateful for all the help I can get. If you find a mistake make a PR and please have a source so I can confirm the correction. If you have any suggestions feel free to open an issue. Credit: @TSiege
